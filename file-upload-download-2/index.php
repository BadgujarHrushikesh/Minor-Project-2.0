...
<head>
  ...
  <title>E-Vidya | Admin Pannel |Publish Notice</title>
</head>

<body>
<div class="heading" style="background-color: #ffc107;height:3rem;width: 100vw;">
    <h2 style="text-align: center; padding: 0.4rem;">E-Vidya Admin Pannel</h2>
  </div>
  <!-- navigation Bar -->
    ...
    <div class="container-fluid">>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/E-vidya-Minor-Project/file-upload-download-1/">Publish Notes</a>
          </li>
          </li>
          <li class="nav-item">
            <a class="nav-link  active" href="#" target="_blank">Publish Notice</a>
          </li>
          <li class="nav-item">
        ...
        <form class="d-flex">
          <!-- <button class="btn btn-outline-warning  m-2" style="width:10rem; ;" type="button" data-bs-toggle="modal"
            data-bs-target="#Aprofilemodal"><i class="bi bi-person-circle"></i>
            &nbsp;Profile</button> -->
          <button class="btn btn-outline-warning  m-2" style="width:10rem; ;" type="submit"><i
  ...
  <div class="content" style="width:100%;">
    <div class="form ">
      <form enctype="multipart/form-data" action="" name="form" method="post" style="max-width:800px; height: 800px;margin:auto ;padding:55px;">
      <!-- <form action="" style="max-width:800px; height: 800px;margin:auto ;padding:55px;"> -->
        <h2 style="color: #ffffff; text-align: center;">Publish Notice</h2>

        <div class="input-container p-2">
          <i class="bi bi-card-heading icon"></i>
          <input type="text" name="title" id="title" placeholder="Title For Notice" class="input-field box" /><br>
        </div>


        <div class="input-group mb-2 input-container p-2">
          <i class="bi bi-file-earmark-pdf-fill icon-file-input"></i>
          <label class="input-group-text label-color" for="notesf">Upload Notice Pdf</label>
        ...
        <div class="input-container p-2">
          ...
          <!-- <button type="submit" class="submit-btn p-2"><i class="bi bi-arrow-up-square icon"></i>Publish Notice
          </button> -->
        </div>
...
<footer class="py-3 footer-back">
  ...
  <p class="text-center text-muted">© 2022 Hrushikesh , Inc</p>
</footer>
